...
// Consulta para obtener los productos de oro
$sql = "SELECT id_producto, Nombre, Costo as precio FROM producto WHERE id_producto IN (9, 10, 11)";
...
<head>
    ...
    <title>Abridores de Oro 18k</title>
    <script>
...
<body>
    <h1>Abridores de Oro 18k</h1>

    <?php if (!empty($productos)): ?>
        <?php foreach ($productos as $producto): ?>
        <div class="product">
            <h2>Abridor de Oro 18k <?php echo htmlspecialchars($producto['id_producto']); ?></h2>
            <img src="../fotos/oro<?php echo htmlspecialchars($producto['id_producto']); ?>.jpeg" alt="Abridor de Oro 18k <?php echo htmlspecialchars($producto['id_producto']); ?>" style="width: 300px; height: auto;">
